...
export const SortedIdeas = ({limit = 4, needPagination = false, seeMoreBtnOnClick}: SortedIdeasProps) => {
    ...
    return (
        <section className="sorted-ideas">
            ...
            {seeMoreBtnOnClick &&
                ...
                data?.ideas &&
                data.ideas.length > 0 &&
                <p className="sorted-ideas__see-more-btn" onClick={seeMoreBtnOnClick}>See More...</p>}
        </section>
    );
};
