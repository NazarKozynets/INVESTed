...
export const ForumDetails = () => {
  ...
  const closeForumMutation = useMutation({
    mutationFn: () => {
      if (!forumId) return Promise.reject(new Error("Try again later"));
  ...
  const renderComments = (comments: ForumCommentModel[]) => {
    return comments
      .sort(
        (a, b) =>
            ...
            >
                ...
                <div className="forum-details__comment-user-block">
                  ...
                  {!forum?.isClosed && forum?.canEdit && (
                    <div
                      ...
                      onClick={() =>
                        changeCommentHelpfulStatusMutation.mutate(comment.id)
                      }
              ...
              {comment.isHelpful && (
                <div className="forum-details__comment-helpful-response">
                  ...
                  <img src={crownIcon} alt="helpful img" />
                </div>
              )}
            </motion.div>
          );
      ...
      {forum && !isError && !isLoading && !isFetching && (
        ...
        >
          <div className="forum-details__header">
            <div
              ...
              style={{
                ...
                color: forum.isOwnerBanned ? "red" : "white",
              }}
            >
              <UserProfileIcon
          ...
          {forum.canEdit && !forum.isClosed && (
            <Button
              text="Close"
              className="forum-details__close-btn"
