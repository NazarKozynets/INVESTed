...
export const AboutUsPage = () => {
    ...
    const nextPage = () => setPageIndex((prev) => (prev < contentForInfoForm.length - 1 ? prev + 1 : prev));
    const prevPage = () => setPageIndex((prev) => (prev > 0 ? prev - 1 : prev));

    return (
        <section>
            <div className="about-us-content-container">
                <button onClick={prevPage} className="about-us-nav-btn" id="left-button">
                    {'<'}
                </button>
                ...
                <button onClick={nextPage} className="about-us-nav-btn" id="right-button">
                    {'>'}
                </button>
            </div>
