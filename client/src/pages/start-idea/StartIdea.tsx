...
export const StartIdea = () => {
    ...
    const handleSubmit = async () => {
        ...
        const parsedDeadline = parse(formattedDeadlineString, 'dd-MM-yyyy', new Date());
            ...
            <Form className="start-idea-form">
                <div className="form-content">
                    ...
                    <div className="form-section">
                        ...
                        />
                        <p className="hint-text">
                            Set the date by which you want to collect the funds (e.g., 31-12-2025).
                        </p>
                        {errors.deadline && <p className="error-text">{errors.deadline}</p>}
                    </div>

                    <div className={`in-out-form-container ${isIdeaReady ? "visible" : ""}`}>
                        <Button text="Start idea" className="start-idea-submit-btn" onClick={handleSubmit}/>
                    </div>
                </div>
            </Form>
        </section>
