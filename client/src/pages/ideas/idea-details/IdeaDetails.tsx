...
export const IdeaDetails = () => {
  ...
  const closeMutation = useMutation({
    mutationFn: () => {
      if (!ideaId?.trim()) return Promise.reject(new Error("Empty ideaId"));
            ...
            >
              <div className="idea-details__comment-header">
                <div className="idea-details__comment-user-block">
                  ...
                  >
                    <UserProfileIcon
                      username={comment.commentatorUsername}
  ...
  return (
    <section className="idea-details">
      ...
      {idea && !isLoading && !isFetching && !isError && (
        <div>
          <div
            className={`idea-details__header ${idea.isClosed ? "closed" : "open"}`}
          >
            <div className="idea-details__header-left">
              {!idea.isClosed && idea.canEdit && (
                <Button
                  text="Close"
                  className="idea-details__header-close-btn"
          ...
          <StarRating
            ...
            interactive={!!userId && !idea.isClosed && userRole !== "Admin"}
          />
