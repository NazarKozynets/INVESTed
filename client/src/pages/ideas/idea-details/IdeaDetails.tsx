...
import {
    rateIdea,
    addCommentToIdea,
    deleteCommentFromIdea, closeIdea,
...
import "../../../styles/pages/_ideaDetailsPage.scss";
...
export const IdeaDetails = () => {
    ...
    const closeMutation = useMutation({
        mutationFn: () => {
            if (!ideaId?.trim())
                return Promise.reject(new Error("Empty ideaId"));
            return closeIdea(ideaId.trim());
        },
        onSuccess: () => {
            queryClient.invalidateQueries({queryKey: ["idea-details", ideaId]});
            toast.success("Idea closed successfully!");
        },
        onError: (error) => {
            console.error(error);
        },
                        ...
                        >
                            <div className="idea-details__comment-header">
                                <div className="idea-details__comment-user-block">
                                    ...
                                    {(userId === comment.commentatorId || userRole !== "Client") && !idea.isClosed && (
                                        <div
    ...
    return (
        <section className="idea-details">
            ...
            {idea && !isLoading && !isFetching && !isError && (
                <div>
                    <div className={`idea-details__header ${idea.isClosed ? "closed" : "open"}`}>
                        <div className="idea-details__header-left">
                            {!idea.isClosed && idea.canEdit && (
                                <Button text="Close" className="idea-details__header-close-btn"
                        ...
                        <div className="idea-details__header-right">
                    ...
                    {((userRole == "Client" && !idea.canEdit) || userRole === "Moderator") && !idea.isClosed && (
                        ...
                        {!idea.isClosed &&
                            (commentMutation.isPending ? (
                                ...
                                <TextInput
                                    ...
                                    className="idea-details__respond-btn"
                                />
                            ))}
