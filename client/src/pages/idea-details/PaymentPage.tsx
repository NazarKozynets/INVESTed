...
export const PaymentPage = () => {
    ...
    if (authState.userData?.role !== "Client")
        window.history.back();

    return (
        <div>
            <h1 style={{textAlign: "center", marginBottom: "1rem", marginTop: "5rem"}}>Support the Idea</h1>
            <p style={{textAlign: "center", color: "#ccc", marginBottom: "2rem", fontSize: 18}}>
                Enter the amount you'd like to invest. Your support helps turn ideas into reality!
            </p>
